...
const Conexion = () => {
    ...
    const handleSubmit2 = (e) => {
        ...
        firebase.loginUser(email2,password2)
                   ...
                   <div className="formBx">
                       <form onSubmit={handleSubmit2} >
                           ...
                           <div className="signup">
                              <p>Don't have an account ? <Link onClick={()=> activeRef.current.classList.toggle('active')} >Sign Up</Link></p> 
                           </div>
                       </form>
                   </div>
               </div>
               <div className="user signupBox">
                   <div className="formBx">
                       <form onSubmit={handleSubmit} >
                           ...
                           <div className="signup">
                             <p>already have an account ? <Link  onClick={()=> activeRef.current.classList.toggle('active')}>Sign In</Link> </p>   
                           </div>
                       </form>
                   </div>
